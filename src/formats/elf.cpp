...
Result<ELFImage> parse_elf_image(std::span<const std::byte>d){
 ...
 try{
  ...
  i.type=r.u16(16);i.machine=r.u16(18);i.version=r.u32(20);i.entry=r.ux(24,x);i.phoff=r.ux(28,x);i.shoff=r.ux(x?40:32,x);i.flags=r.u32(x?48:36);i.phentsize=r.u16(x?54:42);i.phnum=r.u16(x?56:44);i.shentsize=r.u16(x?58:46);i.shnum=r.u16(x?60:48);i.shstrndx=r.u16(x?62:50);i.header_status=ParseStatus::Valid;

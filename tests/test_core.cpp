...
std::vector<std::byte> fixture(){
 ...
 p64(b,0xE00,0x140003800ull);p64(b,0xE08,0x140003808ull);p64(b,0xE10,0x140002900ull);p64(b,0xE18,0x140002C00ull);p32(b,0xE20,0);p32(b,0xE24,0);p64(b,0x1600,0x140001100ull);p64(b,0x1608,0);
